...
joined_data_aug %>% 
  ...
  labs(title = "Age distribution for different cancer types",
       x = 'Age',
       y = 'Count') + 
  myplot_aes
...
ggsave(plot = plot_TvsPAM50_boxplot, 
       filename = "results/03_EDA_boxplot_T_vs_PAM50_mapping.png",
       device = "png",)
